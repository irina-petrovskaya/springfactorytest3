...
//
    ...
    public void testConfigComponent11() {
        System.out.println("\"myprops.configcomp11\"=" + environment.getProperty("myprops.configcomp11"));
        System.out.println("\"myprops.configcomp11inner\"=" + environment.getProperty("myprops.configcomp11inner"));
        if ((environment.getProperty("myprops.configcomp11").equals("true")) && (environment.getProperty("myprops.configcomp11inner").equals("true"))) {
            ...
            if (!(environment.getProperty("myprops.configcomp11").equals("true"))) {
                System.out.println("condition for configcomponent11 are broken:");
                ...
                System.out.println("condition for configcomponent11inner only is broken:");
                System.out.println("configComponent1 should be available, but bean16_from_confcomp11inner and confComp11Inner beans should not be available");
                Assert.assertNotNull(configComponent11);
                Assert.assertNull(confComp11Inner);
                Assert.assertNull(bean16_from_confcomp11inner);
            }
